    ...
    <View style={styles.container}>
      ...
      <View style={styles.filterRow}>
        ...
        <TouchableOpacity
          style={[
            styles.filterBtn,
            selectedFilter === "active" && styles.filterBtnActive,
          ]}
        ...
        <TouchableOpacity
          style={[
            styles.filterBtn,
            selectedFilter === "delivered" && styles.filterBtnActive,
          ]}
          ...
          filteredOrders.map((order) => {
            ...
            return (
              <Card key={order.id} style={styles.orderCard}>
                    ...
                    <View style={styles.courierHeader}>
                      <View style={{ flex: 1 }}>
                        <Text style={styles.countdownTitle}>
                          ⚡ Livraison estimée : ~
                          {order.estimated_delivery_minutes || 15} min
                        </Text>
                        <Text style={styles.courierName}>
                          🛵{" "}
                          {order.driver_name ||
                            "Mehdi (Coursier QuickLivraison Oujda)"}
                        </Text>
                      </View>
                      ...
                      <View style={styles.contactButtonsRow}>
                        <TouchableOpacity
                          ...
                          onPress={() =>
                            Linking.openURL(
                              `tel:${order.driver_phone || "+212661223344"}`,
                            )
                          }
                          activeOpacity={0.8}
                        >
                        ...
                        <TouchableOpacity
                          ...
                          onPress={() => {
                            const cleanPhone = (
                              order.driver_phone || "212661223344"
                            ).replace(/[^0-9]/g, "");
                            Linking.openURL(
                ...
                {/* Real-time Interactive Live Map for Active Orders */}
                {isActive && (
                  <View style={{ marginTop: 12, marginBottom: 12 }}>
                    ...
                    >
                      🗺️ Suivi de livraison en direct (Oujda) :
                    </Text>
                    <LiveTrackingMap
                      courierLocation={{
                      ...
                      restaurantLocation={{
                        ...
                        name: "Restaurant QuickLivraison Oujda",
                      }}
